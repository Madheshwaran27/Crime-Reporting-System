...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2023 at 06:55 PM
...
(2, 123456789012, 'chennai', 'Pick Pocket', '2023-04-06', 'hello iam travelling in a bus ,some one stole my purse', 'Unassigned', 'null', 'Null');
...
('arun7@gmail.com', 'arun', 'chennai', 'ak47'),
...
(1, '2023-04-03 15:56:37', 'Criminal Verified');
...
INSERT INTO `user` (`u_name`, `u_age`, `u_id`, `u_pass`, `u_addr`, `a_no`, `gen`, `mob`) VALUES
('Satyansh Kumar', 0, 'satyansh123@gmail.com', 'satyansh', 'Ranchi', 123214521452, 'Male', 9854123654),
('madhesh', 0, 'madhesh@gmail.com', 'madhesh123', 'abcdefgh', 123456789012, 'Male', 6578768879),
('johnwick', 20, 'johnwick@gmail.com', 'johnwick', 'dsfgfgfdghfghgfhghgfhgfdghgfgffhgfhghghgfh', 123456789017, 'Male', 123456789010);
